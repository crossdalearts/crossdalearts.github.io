...
1. Learners Feedback background color match to artist statement background with card inside color *{Done}*
2. New Payment Links on Razorpay and Wise both for Ex-students *{Done}*
3. Wise Payment Gateway for Internation Students *{Done}*
4. New & Ex Student Modal *{Done}*
5. JSON of Valid PaymentIDs *{Done}*
6. Coupon Code feature (Uses Hardcoded Value as Password) *{Done}*
7. Validation *{Done}*
...
3. Artworks for sale button in the front
4. make the 49 out of 50 to 48 out of 50 *{Done}*
5. cut button transform stay intact *{Done}*
